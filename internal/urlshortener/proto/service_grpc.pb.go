...
const (
	ShortenerService_Create_FullMethodName      = "/auth.ShortenerService/Create"
	ShortenerService_GetByID_FullMethodName     = "/auth.ShortenerService/GetByID"
	ShortenerService_GetByAuthor_FullMethodName = "/auth.ShortenerService/GetByAuthor"
	ShortenerService_GetByAlias_FullMethodName  = "/auth.ShortenerService/GetByAlias"
	ShortenerService_UpdateAlias_FullMethodName = "/auth.ShortenerService/UpdateAlias"
	ShortenerService_Delete_FullMethodName      = "/auth.ShortenerService/Delete"
)
...
type ShortenerServiceClient interface {
	...
	GetByAuthor(ctx context.Context, in *GetByAuthorRequest, opts ...grpc.CallOption) (*ListLinkResponse, error)
	...
	Delete(ctx context.Context, in *UpdateAliasRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *shortenerServiceClient) GetByAuthor(ctx context.Context, in *GetByAuthorRequest, opts ...grpc.CallOption) (*ListLinkResponse, error) {
...
func (c *shortenerServiceClient) Delete(ctx context.Context, in *UpdateAliasRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
type ShortenerServiceServer interface {
	...
	GetByAuthor(context.Context, *GetByAuthorRequest) (*ListLinkResponse, error)
	...
	Delete(context.Context, *UpdateAliasRequest) (*emptypb.Empty, error)
}
...
func (UnimplementedShortenerServiceServer) GetByAuthor(context.Context, *GetByAuthorRequest) (*ListLinkResponse, error) {
...
func (UnimplementedShortenerServiceServer) Delete(context.Context, *UpdateAliasRequest) (*emptypb.Empty, error) {
...
func _ShortenerService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ShortenerServiceServer).Delete(ctx, req.(*UpdateAliasRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ShortenerService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "auth.ShortenerService",
